...
namespace Synfonia.Backend
{
    class PartialHTTPStream : Stream
    {
        ...
        public PartialHTTPStream(string url, string bearerToken)
            : this(url, bearerToken, 1024)
        {
        }

        public PartialHTTPStream(String url, string bearerToken, Int64 cacheLength)
        {
